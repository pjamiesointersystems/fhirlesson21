...
CLIENT_SECRET = os.getenv("AUTH0_CLIENT_SECRET", "WYO9Qepahvk2x3DncJBZN770nXXZrW-Gzo5ICbN8GfK7LzajP9WaUehjsEFhF8Zw")
FHIR_BASE     = os.getenv("FHIR_BASE",     "https://localhost:8443/csp/healthshare/demo/fhir/r4")
REDIRECT_URI  = os.getenv("AUTH0_REDIRECT_URI", "http://127.0.0.1:8900/cb")
SCOPE         = os.getenv("AUTH0_SCOPE", "openid profile patient/Patient.r patient/Observation.r")
